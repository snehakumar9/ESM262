...
```{r}
source("../ESM262_HW5/function/forest_sequestration.R")
treeID <- c(1:500)
...
```{r}
for(n in 1:500 ){
  tree_data$biomass_per_tree[n]=
    tree_data$bm_conversion_factor[n]*tree_dimensions[n]
}

for(n in 1:500){
  tree_data$tree_dimensions[n]=
    tree_data$diameter[n]*height[n]
}  
